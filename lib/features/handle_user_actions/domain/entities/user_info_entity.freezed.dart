...
abstract class $UserInfoEntityCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String email, String name, String gender, String status});
}
...
class _$_UserInfoEntity implements _UserInfoEntity {
  ...
  @override
  String toString() {
    return 'UserInfoEntity(id: $id, email: $email, name: $name, gender: $gender, status: $status)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, id, email, name, gender, status);
...
abstract class _UserInfoEntity implements UserInfoEntity {
  const factory _UserInfoEntity(
      ...
      required final String status}) = _$_UserInfoEntity;
